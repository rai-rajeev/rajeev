...
for (let i=0;i<30;i++){
    var im=yuo.products[i].images[0];
    var ati=document.getElementsByClassName("card")[i].getElementsByTagName("img")[0];
    ati.setAttribute("src",im);
    var ID=document.getElementsByClassName("card-text")[i].getElementsByTagName("span")[0];
    var IDV=document.getElementsByClassName("card-text")[i].getElementsByTagName("span")[1];
    var ids=yuo.products[i].id;
    ID.innerHTML="id :";
    IDV.innerHTML=ids;
    
    var title=document.getElementsByClassName("card-text")[i].getElementsByTagName("span")[2];
    var titlev=document.getElementsByClassName("card-text")[i].getElementsByTagName("span")[3];
    var titls=yuo.products[i].title;
    title.innerHTML="Title  :";
    titlev.innerHTML=titls;
    
    var disc=document.getElementsByClassName("card-text")[i].getElementsByTagName("span")[4];
    var discv=document.getElementsByClassName("card-text")[i].getElementsByTagName("span")[5];
    var tdics=yuo.products[i].description;
    disc.innerHTML="Discription:";
    discv.innerHTML=tdics;
    
//    var price=document.getElementsByClassName("card-text")[i].getElementsByTagName("span")[6];
//   var privev=document.getElementsByClassName("card-text")[i].getElementsByTagName("span")[7];
//    var prics=yuo.products[i].price;
//    title.innerHTML="prices  :";
//    titlev.innerHTML=prics;
    
//    var dper=document.getElementsByClassName("card-text")[i].getElementsByTagName("span")[8];
//    var dperv=document.getElementsByClassName("card-text")[i].getElementsByTagName("span")[9];
//    var dperc=yuo.products[i].discountPercentage;
//    dper.innerHTML="Discount percentage  :";
//    dperv.innerHTML=dperc;
//    
//    var rat=document.getElementsByClassName("card-text")[i].getElementsByTagName("span")[10];
//    var ratv=document.getElementsByClassName("card-text")[i].getElementsByTagName("span")[11];
//    var rti=yuo.products[i].rating;
//    rat.innerHTML="Rating  :";
//    ratv.innerHTML=rti;
//    
//    var stock=document.getElementsByClassName("card-text")[i].getElementsByTagName("span")[12];
//    var stkv=document.getElementsByClassName("card-text")[i].getElementsByTagName("span")[13];
//    var stks=yuo.products[i].stock;
//    stock.innerHTML="Stock  :";
//    stkv.innerHTML=stks;
//    
//    var brand=document.getElementsByClassName("card-text")[i].getElementsByTagName("span")[14];
//    var branv=document.getElementsByClassName("card-text")[i].getElementsByTagName("span")[15];
//    var bry=yuo.products[i].brand;
//    brand.innerHTML="Brand  :";
//    branv.innerHTML=bry;
//    
//    var cat=document.getElementsByClassName("card-text")[i].getElementsByTagName("span")[16];
//    var catv=document.getElementsByClassName("card-text")[i].getElementsByTagName("span")[17];
//    var cts=yuo.products[i].category;
//    cat.innerHTML="Category  :";
//    catv.innerHTML=cts;
    
}
//var y=document.forms.sbar;
//y.onsubmit=function(){
//    var myvar=document.forms.mform.search.value;
//    if(abc!=""){
//        for(let j=0;j<30;j++){
//            if(abc==yuo.products[j].title || abc==yuo.products[j].description;){continue;}
//            else{
//                var mu=document.getElementsByClassName("col")[j];
...
//    else{
//        for(let l=0;l<30;l++){
//        var pyu=document.getElementsByClassName("col")[l];
//            pyu.style.display="block";
//        }
//    }
//    
//}